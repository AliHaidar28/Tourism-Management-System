		...
		<div align ="center">
			<fieldset>
				...
				<table>
					...
					<td align="center" colspan="2"><input type="submit" name="AddNurse"value="Add Nurse"></td>
					</tr>
					<tr>
					<td align="center" colspan="2"><input type="submit" name="EditNurse"value="Edit Nurse"></td>
					</tr>
					<tr>
					<td align="center" colspan="2"><input type="submit" name="DeleteNurse"value="Delete Nurse"></td>
					</tr>
				</form>
			</fieldset>
		</div>
