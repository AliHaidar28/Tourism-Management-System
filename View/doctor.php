		...
		<div align ="center">
			<fieldset>
				...
				<table>
					...
					<td align="center" colspan="2"><input type="submit" name="AddDoctor"value="Add Doctor"></td>
					</tr>
					<tr>
					<td align="center" colspan="2"><input type="submit" name="EditDoctor"value="Edit Doctor"></td>
					</tr>
					<tr>
					<td align="center" colspan="2"><input type="submit" name="DeleteDoctor"value="Delete Doctor"></td>
					</tr>
